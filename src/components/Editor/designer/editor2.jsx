    ...
    <>
        ...
        <Stack direction="row" spacing={2} justifyContent="space-between">
          ...
          >
            ...
            <Button size="sm" value="tablet">
              <Icon icon="material-symbols:tablet-mac" width="24" height="24" />
            </Button>
          ...
          <Stack direction="row" spacing={2}>
            ...
            >
              {isSaving && (
                <Icon icon="svg-spinners:eclipse" width="24" height="24" />
              )}
            ...
            <Dropdown>
              ...
              >
                <Icon icon="akar-icons:more-vertical" width="24" height="24" />
              </MenuButton>
      ...
      >
        ...
        >
          {
            /* current Tab */
            currentTab === "element_options" ? <ToolOptions /> : <Toolbar />
          }
        </Sheet>
      </Drawer>
      ...
      >
        <Button
          ...
          color="primary"
          onClick={() => {
            handleCurrentTab("all_components");
